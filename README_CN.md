...
Aquila2项目基于 [Apache 2.0 license](https://www.apache.org/licenses/LICENSE-2.0) 协议；Aquila2系列模型则是基于[智源Aquila系列模型许可协议](./assets/aquila_license.pdf)；特别说明，Aquila2 70B系列模型则是基于[智源Aquila 70B系列模型许可协议](./assets/aquila2_70b_license.pdf)。
